...
namespace URApplication.Models.Application.Registry
{
    ...
    {
        public static void DivideRegistryKeyByRegistryKeyAndPath(RegistryKey inKey, out RegistryKey outKey,
            out string path)
        {
            outKey = Microsoft.Win32.Registry.LocalMachine;
            if (!inKey.Name.Contains("LOCAL_MACHINE")) outKey = Microsoft.Win32.Registry.CurrentUser;
